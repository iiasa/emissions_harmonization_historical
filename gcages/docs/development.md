...
1. Bump the version: manually trigger the "bump" workflow from the main branch
   (see here: [bump workflow](https://github.com/organizations/climate-resource/gcages/actions/workflows/bump.yaml)).
...
1. Edit the draft release which has been created
   (see here:
   [project releases](https://github.com/organizations/climate-resource/gcages/releases)).
