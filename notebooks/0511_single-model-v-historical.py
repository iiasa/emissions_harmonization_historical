...
plt.savefig("tmp-for-oliver.pdf", transparent=True)
plt.show()

# %%
# pdf = pd.concat([
#     get_sns_df(scenarios_raw_global.loc[pix.isin(variable=history_cut.pix.unique("variable"))]),
#     get_sns_df(history_cut),
# ])
# make_all_var_plot(
#     data=pdf[pdf["year"] <= 2050],
#     kind="line",
