...
#
# We also have 0109_edgar-prepare.py,
# which is used especially for minor gases (F-gases), on the global level, for climate emulator input.
#
# Instead, this notebook is used to serve the vetting of IAM scenarios
# based on national level harmonization sectors in the same format as what is produced in CEDS-prepare.py
